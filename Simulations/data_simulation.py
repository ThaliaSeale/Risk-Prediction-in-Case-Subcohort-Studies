# Collection of all the functions for simulating data for easy import into other files.
...
def weibull_simple_linear_sim(betas, prop_cat, obs, censor_prop, pi = 0.5):
    # Simulate survival times from a Weibull simulation with linear predictor.
...
def weibull_nonlinear_sim(phi, F_x, obs, censor_prop):
    # Simulate survival times from a Weibull simulation with non-linear predictor.
...
def weibull_interaction(betas, n_cat, obs, censor_prop, show_beta = False, pi = 0.5):
    # Simulate survival times from a Weibull simulation with two independent predictors and their interaction.
...
def AFT_sim(betas, prop_cat, sigma, W, obs, censor_prop, show_beta = False, pi = 0.5):
    # Simulate survival times from an accelerated failure time model.
